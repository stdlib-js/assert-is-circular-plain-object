...
```bash
npm install @stdlib/assert-is-circular-plain-object
```
...
-   [`@stdlib/assert/is-circular-array`][@stdlib/assert/is-circular-array]: test if a value is an array containing a circular reference.
...
[test-image]: https://github.com/stdlib-js/assert-is-circular-plain-object/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/assert-is-circular-plain-object/actions/workflows/test.yml
